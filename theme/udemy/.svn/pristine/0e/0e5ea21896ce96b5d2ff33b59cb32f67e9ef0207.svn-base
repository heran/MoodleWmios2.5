...
$string['set-completion-manual-y'] = 'set mod as completed';
$string['set-completion-manual-n'] = 'set mod as not completed';
$string['course-type-nostart'] = 'Not Start';
$string['course-type-completed'] = 'Completed';
$string['course-type-inprogress'] = 'In progress';
$string['view_this_course'] = 'View This Course';
$string['next_lecture'] = 'Next Lecture';
$string['you_completed_course'] = 'You have completed <b>{$a->my}</b> of <b>{$a->total}</b> lectures in this course';
$string['continue_course'] = 'Continue with Lecture: {$a}';
$string['curriculum'] = 'curriculum';
$string['section'] = 'SECTION';
$string['currentcourse'] = 'Current Course';
$string['continue_with_course_mod'] = 'Continue With Content:{$a}';
$string['start_with_course_mod'] = 'Start With Content:{$a}';
$string['course_has_no_mod'] = 'Course Has No Mod';
$string['revisit_lecture'] = 'Revisit Lecture';
$string['start_lecture'] = 'Start Lecture';
$string['back_to_course'] = 'Back To Course';
$string['auto_play'] = 'Auto Play';
$string['prev_lecture'] = 'Prev Lecture';
$string['resume_mod'] = 'Resume Mod';
$string['type_your_note'] = 'Start typing to take your note,Press Ctrl+Enter to save';
$string['down_load_notes'] = 'Download Your Notes';
$string['mod_intro'] = 'Mod Info';
$string['type_your_question'] = 'Type your question about this course(Required)';
$string['follow'] = 'Follow';
$string['global_navigation'] = 'Global Navigation';
$string['start_the_course'] = 'Start The Course';
$string['discover_us'] = 'Dicover Wmios';
$string['get_help'] = 'Get Help';
$string['course-type-completed'] = 'Completed';
$string['course-type-nostart'] = 'Not Start';
$string['course-type-inprogress'] = 'In Progress';
$string['allcategories'] = 'all categories';
$string['all_a_category'] = 'all {$a}';
$string['search_keywords'] = 'Result for';